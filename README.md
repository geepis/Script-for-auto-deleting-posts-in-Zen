RU_ru<br>
Скрипт авто удаления постов в ДЗЕН
<br><br>
Скрипт автоматически удаляет посты в дзен <br>
 <br>
В строке "MAX_DELETE: 500" указываем количество сколько постов надо удалить<br>
 <br>
Запускается скрипт в консоли браузера на странице в URL вместо "ВАШ_ЛОГИН" указываем свой логин в Дзен https://dzen.ru/profile/editor/ВАШ_ЛОГИН/publications?state=published <br>
 <br>
Заходим на указанную страницу, жмем "F12" выбираем вкладку "Консоль" <br>
 <br>
